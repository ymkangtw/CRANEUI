...
export default class ActionACK extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.socket.on('ackActionCompleted', this.updateData);
    }
        ...
        return (
            <Paper style={PaperStyle} zDepth={3}>
                ...
                <table style={TableStyle}>
                    ...
                    <tr>
                        <td>CMDID</td><td>{this.state.reqData.CMDID}</td>
                    </tr>
                    <tr>
                        <td>CMDWORKTIME</td><td>{this.state.reqData.CMDWORKTIME}</td>
                    </tr>
                </table>
            </Paper>
